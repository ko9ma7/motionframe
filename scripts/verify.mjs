...
const checks = [
  ...
  ['custom template persistence', app.includes('motionframe:v3:templates') && app.includes('updateCustomTemplate')],
  ['audio presets', html.includes('soundPresetSelect') && audio.includes('createProceduralBuffer')],
