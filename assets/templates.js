...
export const builtinTemplates = [
  {
    id: 'website-story', title: 'Website Story', category: 'website', badge: '추천', motion: 'scroll', durationLabel: '12.7 sec', audioPreset: 'softPulse',
  ...
  {
    id: 'hero-dive', title: 'Hero Dive', category: 'website', badge: 'Hero', motion: 'zoom', durationLabel: '8.8 sec', audioPreset: 'airPad',
  ...
  {
    id: 'landing-scroll', title: 'Landing Page Scroll', category: 'website', badge: 'Scroll', motion: 'scroll', durationLabel: '13.0 sec', audioPreset: 'softPulse',
  ...
  {
    id: 'section-hopper', title: 'Section Hopper', category: 'website', badge: 'Dynamic', motion: 'cut', durationLabel: '9.2 sec', audioPreset: 'focusGrid',
  ...
  {
    id: 'cta-finale', title: 'CTA Finale', category: 'website', badge: 'Ending', motion: 'zoom', durationLabel: '8.6 sec', audioPreset: 'airPad',
  ...
  {
    id: 'portfolio-glide', title: 'Portfolio Glide', category: 'calm', badge: 'Calm', motion: 'pan', durationLabel: '13.6 sec', audioPreset: 'airPad',
  ...
  {
    id: 'product-tour', title: 'Product Tour', category: 'product', badge: '추천', motion: 'zoom', durationLabel: '10.0 sec', audioPreset: 'focusGrid',
  ...
  {
    id: 'cursor-walkthrough', title: 'Cursor Walkthrough', category: 'cursor', badge: 'Cursor', motion: 'zoom', durationLabel: '9.6 sec', audioPreset: 'focusGrid',
  ...
  {
    id: 'dashboard-scan', title: 'Dashboard Scan', category: 'product', badge: 'Dashboard', motion: 'pan', durationLabel: '10.0 sec', audioPreset: 'softPulse',
  ...
  {
    id: 'feature-spotlight', title: 'Feature Spotlight', category: 'product', badge: 'Feature', motion: 'zoom', durationLabel: '8.9 sec', audioPreset: 'softPulse',
  ...
  {
    id: 'form-flow', title: 'Form Flow', category: 'cursor', badge: 'Form', motion: 'zoom', durationLabel: '9.0 sec', audioPreset: 'focusGrid',
  ...
  {
    id: 'settings-tour', title: 'Settings Tour', category: 'product', badge: 'UI', motion: 'pan', durationLabel: '10.4 sec', audioPreset: 'softPulse',
  ...
  {
    id: 'table-focus', title: 'Data Table Focus', category: 'product', badge: 'Data', motion: 'pan', durationLabel: '9.4 sec', audioPreset: 'focusGrid',
  ...
  {
    id: 'mobile-app-demo', title: 'Mobile App Demo', category: 'mobile', badge: '9:16', motion: 'mobile', durationLabel: '9.6 sec', audioPreset: 'softPulse', aspect: '9:16', frameStyle: 'floating',
  ...
  {
    id: 'launch-cuts', title: 'Launch Cuts', category: 'fast', badge: 'Fast', motion: 'cut', durationLabel: '6.5 sec', audioPreset: 'launchBeat',
  ...
  {
    id: 'quick-demo', title: 'Quick Demo', category: 'fast', badge: 'Short', motion: 'zoom', durationLabel: '5.0 sec', audioPreset: 'launchBeat',
  ...
  {
    id: 'social-punch', title: 'Social Punch', category: 'fast', badge: 'Social', motion: 'cut', durationLabel: '7.2 sec', audioPreset: 'launchBeat', aspect: '9:16', frameStyle: 'floating',
  ...
  {
    id: 'feature-trio', title: 'Feature Trio', category: 'fast', badge: '3 Features', motion: 'cut', durationLabel: '8.2 sec', audioPreset: 'focusGrid',
  ...
  {
    id: 'before-after', title: 'Before / After', category: 'fast', badge: 'Compare', motion: 'pan', durationLabel: '7.4 sec', audioPreset: 'airPad',
  ...
  {
    id: 'release-notes', title: 'Release Notes', category: 'fast', badge: 'Update', motion: 'cut', durationLabel: '8.0 sec', audioPreset: 'focusGrid',
  ...
  {
    id: 'calm-showcase', title: 'Calm Showcase', category: 'calm', badge: 'Calm', motion: 'zoom', durationLabel: '12.5 sec', audioPreset: 'airPad',
  ...
  {
    id: 'editorial-drift', title: 'Editorial Drift', category: 'calm', badge: 'Editorial', motion: 'pan', durationLabel: '13.2 sec', audioPreset: 'airPad',
  ...
  {
    id: 'luxury-scroll', title: 'Luxury Scroll', category: 'calm', badge: 'Premium', motion: 'scroll', durationLabel: '14.4 sec', audioPreset: 'airPad',
  ...
  {
    id: 'slow-product-film', title: 'Slow Product Film', category: 'calm', badge: 'Film', motion: 'zoom', durationLabel: '15.0 sec', audioPreset: 'airPad',
